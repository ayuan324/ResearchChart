"""Configuration values shared across the ResearchChart project."""
...
class StyleConfig:
    """Represents the typographic and color defaults for generated charts."""
...
def apply_matplotlib_style(style: StyleConfig = DEFAULT_STYLE_CONFIG) -> None:
    """Apply the configured typography and palette to Matplotlib globally."""
